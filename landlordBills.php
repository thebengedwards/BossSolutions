    ...
    if (checkPermission('Landlord') == true)
    {
        ...
        $SQLquery = "SELECT SUM(amount) AS rentPaid
                     ...
                     WHERE Landlord.accountID = :landlordID AND tenantTransaction.type = 0 AND year(tenantTransaction.date) =:yearT
                         ";
        $stmt = $dbConn->prepare($SQLquery);
        $stmt->execute(array(':landlordID' => $_SESSION['userID'], ':yearT' => $yearT));
                                    ...
                                    <div style='width: 100%;'>
                                        <table>
                                            <tr>
                                                ...
                                                <td><a href='landlordRent.php'><div class='trancTenantUpcomingHolder'><p>1st {$nextMonth} - £{$monthlyRent}</p></div></a></td>
                                                <td><a href='landlordUtilities.php'><div class='trancTenantUpcomingHolder'><p>15th {$utilDate} - £{$monthlyUtil}</p></div></a></td>
                                            </tr>
                                            <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class='trancTenantDashHolder' onmouseover='changeNameColor(\"trancTName4\")' onmouseout='changeNameColorBack(\"trancTName4\")'>
                                <a href='PropertyLandlord.php'><div class='trancTenantDashHolder2'>
                                    <div class='trancTenantDashName' id='trancTName4'>
                                        <p style='margin-left: 10px; margin-top: 5px;'>Manage Properties</p>
                                    </div>
                                    <div style='margin-left: 10px; margin-right: 10px; '>
                                        <p style='margin-left: 20px; margin-right: 20px; margin-top: 50px; text-align: center'>Click here to make changes to the rent and utility costs of your properties.</p>
                                    </div>
...
<script type="text/javascript">
    ...
    function reloadPageWithDateBack()
    {
        ...
        const page = 'landlordBills.php?rentGraphYear=';
