    ...
    if (checkPermission('Tenant') == true)
    {
        ...
        echo "
                <table class='trancTenantRentInTable'>
                    <tr>
                        <td style='width: 30%;'><h1 style='font-family: \"microsoft sans serif\"; margin-top: 0; margin-bottom: 0; font-size: 20px'>My Rent</h1></td>
                        <td style='width: 30%;'>
                            <a href='tenantPaymentPage.php'><div class='tranTenantRentPaymentButt'>Make Rent Payment</div></a>
                        </td>
                        <td style='width: 30%;'>
                    ...
                    <tr style='background-color: transparent; border: 1px solid #333333;'>
                        ...
                        <td style='width: 30%;'><p style='font-weight: bold; margin-top: 0; margin-bottom: 0;'>£{$monthlyRent}</p></td>
                    </tr>
                    <tr>
...
<script type="text/javascript"> //Rent Chart
    ...
    function reloadPageWithDateBack()
    {
        ...
        const page = 'tenantRent.php?rentGraphYear=';
