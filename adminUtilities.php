                ...
                <table class='trancTenantRentInTable'>
                    <tr>
                        <td style='width: 50%;'>
                            <table>
                            <tr>
                            <td style='width: 25%'><h1 style='font-family: \"microsoft sans serif\"; margin-top: 0; margin-bottom: 0; font-size: 20px'>Utilities Income</h1></td>
                            <td style='width: 20%'>
...
<script type="text/javascript"> //Rent Chart
    ...
    {
        const page = 'adminUtilities.php?rentGraphYear=';
